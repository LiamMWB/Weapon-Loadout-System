...
(function (WeaponLoadoutSystem) {
    ...
    (function (LoadoutType) {
        LoadoutType["Primary_Weapon"] = "Primary Weapon";
        LoadoutType["Secondary_Weapon"] = "Secondary Weapon";
        LoadoutType["Attachment"] = "Attachment";
        LoadoutType["Perk_01"] = "Perk 01";
        LoadoutType["Perk_02"] = "Perk 02";
        LoadoutType["Perk_03"] = "Perk 03";
        LoadoutType["Lethal"] = "Lethal";
        LoadoutType["Tactical"] = "Tactical";
        LoadoutType["Enhancement_01"] = "Enhancement 01";
        LoadoutType["Enhancement_02"] = "Enhancement 02";
        LoadoutType["Enhancement_03"] = "Enhancement 03";
        LoadoutType["Empty"] = "Empty";
    })(LoadoutType = WeaponLoadoutSystem.LoadoutType || (WeaponLoadoutSystem.LoadoutType = {}));
    var PrimaryWeaponType;
    (function (PrimaryWeaponType) {
        PrimaryWeaponType["Assault_Rifle"] = "Assault Rifles";
        PrimaryWeaponType["Submachine_Gun"] = "Submachine Guns";
        PrimaryWeaponType["Sniper"] = "Snipers";
    })(PrimaryWeaponType = WeaponLoadoutSystem.PrimaryWeaponType || (WeaponLoadoutSystem.PrimaryWeaponType = {}));
    var SecondaryWeaponType;
    (function (SecondaryWeaponType) {
        SecondaryWeaponType["Pistol"] = "Pistols";
        SecondaryWeaponType["Shotgun"] = "Shotguns";
    })(SecondaryWeaponType = WeaponLoadoutSystem.SecondaryWeaponType || (WeaponLoadoutSystem.SecondaryWeaponType = {}));
    WeaponLoadoutSystem.enhancementTypes = [
        LoadoutType.Enhancement_01,
        LoadoutType.Enhancement_02,
        LoadoutType.Enhancement_03,
    ];
    WeaponLoadoutSystem.loadoutItemOptions = (_a = {},
        _a[LoadoutType.Primary_Weapon] = [],
        _a[LoadoutType.Secondary_Weapon] = [],
        _a[LoadoutType.Attachment] = [
            {
                name: "Quick Draw",
    ...
    WeaponLoadoutSystem.primaryWeaponSubcategories = (_b = {},
        _b[PrimaryWeaponType.Assault_Rifle] = assaultRifles,
        _b[PrimaryWeaponType.Submachine_Gun] = submachineGuns,
        _b[PrimaryWeaponType.Sniper] = snipers,
        _b);
    WeaponLoadoutSystem.secondaryWeaponSubcategories = (_c = {},
        _c[SecondaryWeaponType.Pistol] = pistols,
        _c[SecondaryWeaponType.Shotgun] = shotguns,
        _c);
